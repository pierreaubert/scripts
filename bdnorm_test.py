...
datas_real_life = [
    ...
    [ '[BD Fr] BD.FR.-.Disparitions.-.02.-.Retour.aux.sources.II.-.(Mazeau-Ersel).cbr', 'Disparitions', '02', 'Retour.aux.Sources.II', 'cbr'],
...
datas_debug = [
    ...
    [ '4 Les Champs d\'Azur - 04 - Sarabande a la turque - (Giroud-Brahy) - [2560].cbr', 'Les.Champs.d.Azur', '04', 'Sarabande.a.la.Turque', 'cbr'],
    # repetition of () ()
