...
datas_real_life = [
    # real life
    [
        "XIII 01 - Le jour du soleil noir.cbr",
        "XIII",
        "01",
    ...
    [
        "XIII 18 - La version Irlandaise (Van.Hamme-Vance).cbr",
        "XIII",
        "18",
    ...
    [
        "XIII Mystery - T01 - La Mangouste.pdf",
        "XIII.Mystery",
        "01",
        "La.Mangouste",
        "pdf",
    ...
    [
        "XIII Mystery - T04 - Colonel Amos.cbz",
        "XIII.Mystery",
        "04",
        "Colonel.Amos",
        "cbz",
    ...
    # prb with unicode
    [
        "Assassin Royal - T01 - Le Bâtard.cbr",
        "Assassin.Royal",
        "01",
        "Le.Batard",
        "cbr",
    ...
    # dealing with HS
    [
        "Valerian HS - Par Les Chemins De L Espace.cbr",
        "Valerian",
        "HS",
    ...
    [
        "Valerian THS - Par Les Chemins De L Espace.cbr",
        "Valerian",
        "HS",
        "Par.les.Chemins.de.l.Espace",
        "cbr",
    ...
    # encoding prb
    [
        "Yoko.Tsuno_06_Les.3.Soleils.de.Vinéa.zip",
        "Yoko.Tsuno",
        "06",
        "Les.3.Soleils.de.Vinea",
        "zip",
    ],
    # complex with 2 numbers
    [
        "BD.FR.-.Waterloo.1911.-.T02.-.Welly.le.petit.(Zarcone-Gloris).zip",
        "Waterloo.1911",
        "02",
        "Welly.le.Petit",
        "zip",
    ...
    # another rare number
    [
        "Tif et Tondu - 026#045 - Le Gouffre Interdit.zip",
        "Tif.et.Tondu",
        "026",
        "Le.Gouffre.Interdit",
        "zip",
    ...
    # HS syntax
    [
        "Valerian THS1 - Par Les Chemins De L Espace.cbr",
        "Valerian",
        "HS1",
        "Par.les.Chemins.de.l.Espace",
        "cbr",
    ...
    # HS syntax variant
    [
        "Valerian THS 01 - Par Les Chemins De L Espace.cbr",
        "Valerian",
        "HS01",
        "Par.les.Chemins.de.l.Espace",
        "cbr",
    ...
    # double numbers
    [
        "Secrets Bancaires - T01 - Les Associes 11    (1920).cbr",
        "Secrets.Bancaires",
        "01",
        "Les.Associes.11",
        "cbr",
    ...
    [
        "Serenity.Firefly/01 - Serenity - Those Left Behind 1 of 3.cbr",
        "Serenity",
        "01",
        "Those.Left.Behind",
        "cbr",
    ...
    [
        "[BD Fr] Agence Touristes - T01 - Voyages a la carte [1920].cbr",
        "Agence.Touristes",
        "01",
        "Voyages.a.la.Carte",
        "cbr",
    ...
    # variant of numbers
    [
        "Terres Lointaines V4 #4 (of 5) (2011).pdf",
        "Terres.Lointaines",
        "4",
        "2011",
        "pdf",
...
datas_debug = [
    ...
    # inversion in title
    [
        "[BD-FR] - Sang des Porphyre (Le) - 01 - Soizic.rar",
