import unittest
import sffchecker
from sffchecker import normalize_authors, normalize_author, lookslikeinitial, \
    group_by_collection, group_by_title, remove_last_number, grab_last_number, \
    lookup_match_authors, scan_dir
...
class CheckOnGoldDatas(SFFCheckerTest):
    ...
    def setUp(self):
        ...
        self.dir_calibre = './tests/calibre'
        self.dir_sffupdate = './tests/sff'
    ...
    def test_sanity(self):
        exact, notfound = lookup_match_authors(self.calibre, self.sff)
